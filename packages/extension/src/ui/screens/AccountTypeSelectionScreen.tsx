...
export const AccountTypeSelectionScreen: FC = () => {
  ...
  useEffect(() => {
    ...
    addAccountType(
      new AccountType("secp256k1 signing", "Team", "v0.0.1", "This bla"),
    )
    addAccountType(
      new AccountType("Fee delegation", "Team", "v0.0.1", "This bla"),
    )
    addAccountType(
      new AccountType("Debit wallet", "Team", "v0.0.1", "This bla"),
    )
  }, [])
