  ...
  useEffect(() => {
    addAccountType(
      new AccountType(
        ...
        "OpenZeppelin",
        "v0.0.1",
        "Default account contract implementation from OpenZeppelin.",
      ),
    )
    const filteredContract = new AccountType(
      ...
      "Team Brevery",
      "v0.0.1",
      "This account contract allows you to create an allow- and denylist for your transactions. It has different security modes to increase the security of your wallet usage.",
    )
    ...
    const fee_insurance = new AccountType(
      "fee_insurance",
      "Fee Insurance Account",
      "Team Brevery",
      "v0.0.1",
      "This account contract allows you to create an allow- and denylist for your transactions. It has different security modes to increase the security of your wallet usage.",
    )
    fee_insurance.setIcon(
      "data:image/png;base64,",
    )
    addAccountType(fee_insurance)
    addAccountType(new AccountType("multisig", "Multisignature Account", "Team", "v0.0.1", "Multi-signature account contract."))
    addAccountType(new AccountType(
      "custo_crypto",
      "Custom Cryptographic Digital Signature Account",
      "TBD",
      "v0.0.1",
      "This account contract allows you any other digital signatur method.",
    ))
  }, [])
